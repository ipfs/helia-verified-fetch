...
Verified‑fetch can be extended to alter how it handles requests by using plugins.
...
You can find more information about plugins in the [PLUGINS.md](./PLUGINS.md) file.
